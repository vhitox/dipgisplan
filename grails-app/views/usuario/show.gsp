			...
			<ol class="property-list usuario">
				...
				<li class="fieldcontain">
					<span id="area-label" class="property-label"><g:message code="usuario.area.label" default="Area" /></span>
						...
						<span class="property-value" aria-labelledby="area-label"><g:link controller="area" action="show" id="${usuarioInstance?.area?.id}">${usuarioInstance?.area?.encodeAsHTML()}</g:link></span>
